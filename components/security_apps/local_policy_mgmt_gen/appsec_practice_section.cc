...
WebAppSection::WebAppSection(
    ...
    csrf_protection_mode(parsed_appsec_spec.getWebAttacks().getProtections().getCsrfProtectionMode()),
    open_redirect_mode(parsed_appsec_spec.getWebAttacks().getProtections().getOpenRedirectMode()),
    error_disclosure_mode(parsed_appsec_spec.getWebAttacks().getProtections().getErrorDisclosureMode()),
